...
function showDate() {
    var sValue = getFullYear(dNow) + "年" + (dNow.getMonth() + 1) + "月" + dNow.getDate() + "日" + " " +(new Date().getHours().toString().length<2?"0"+new Date().getHours():new Date().getHours())+":"+(new Date().getMinutes().toString().length<2?"0"+new Date().getMinutes():new Date().getMinutes())+":"+(new Date().getSeconds().toString().length<2?"0"+new Date().getSeconds():new Date().getSeconds())+" "+ sWeek[dNow.getDay()] + " ";
