...
$cfg_basehost = '';
$cfg_cmspath = '';
$cfg_cookie_encode = 'NTPTmltIgDOgGbHdl2P6YqvxLEeGpOv';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '太原市公安局西山分局';
$cfg_adminemail = 'admin@ewbsite.com';
$cfg_html_editor = 'ckeditor';
$cfg_arcdir = '/a';
$cfg_medias_dir = '/uploads';
$cfg_ddimg_width = 11240;
$cfg_ddimg_height = 680;
$cfg_domain_cookie = '';
$cfg_imgtype = 'jpg|gif|png';
$cfg_softtype = 'zip|gz|rar|iso|doc|xls|ppt|wps|xlsx';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 太原市公安局西山分局 版权所有
