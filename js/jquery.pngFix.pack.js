...
(function(m) {
    jQuery.fn.pngFix = function(c) {
        c = jQuery.extend({
                blankgif: 'http://www.zhangxinxu.com/study/image/pixel.gif'
            },
            c);
        ...
        if (jQuery.browser.msie && (e || f)) {
            jQuery(this).find("img[src$=.png]").each(function() {
                ...
                b += '<span ' + g + h + i + j;
                b += 'style="widows:inherit;white-space:pre-line;display:inline-block;background:transparent;' + k + d;
                ...
                b += l + '"></span>';
                if (a != '') {
                    b = '<span style="widows:inherit;display:inline-block;' + a + d + 'width:' + jQuery(this).width() + 'px;height:' + jQuery(this).height() + 'px;">' + b + '</span>'
                }
                jQuery(this).hide();
                jQuery(this).after(b)
            });
